...
rus3000 = 'https://drive.google.com/file/d/11us_2ZfNwm_ooFU_ZxebGigmM6rLtvv3/view?usp=sharing'
ruspath = 'https://drive.google.com/uc?export=download&id='+rus3000.split('/')[-2]
#earndict = pd.read_pickle(earnpath)
Russell3000 = pd.read_csv(ruspath)
ruslist = Russell3000['Ticker'].values.tolist()
